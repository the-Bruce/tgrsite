...
from .views import ApprovalVoteView, DoneView, ApprovalResultView, HomeView, VoteView, FPTPResultView, FPTPVoteView, \
    STVVoteView, STVResultView, UpdateElection, CreateElection
...
urlpatterns = [
    ...
    path('edit/<int:election>/', UpdateElection.as_view(), name="update_candidate"),
    path('create/', CreateElection.as_view(), name="create_candidate"),
]
