...
end:"",placeholder:"\n    Add your code block here\n"},code:{start:"`",end:"`",placeholder:"Add inline code here"},ul:{start:"* ",end:"",placeholder:"List Item"},ol:{start:"1. ",end:"",placeholder:"List Item"}};return this.each(function(){var d=this,c=a('<div class="controls" />');a(d).before(c.append('<div class="btn-toolbar" role="toolbar" aria-label="Markdown Toolbar"><div class="btn-group mr-2 mb-1" role="group" aria-label="Formatting"> <button type="button" class="btn btn-light c-bold">Bold</button> <button type="button" class="btn btn-light c-italic">Italic</button> <button type="button" class="btn btn-light c-head">Header</button> <button type="button" class="btn btn-light c-code">Code</button></div><div class="btn-group mr-2 mb-1" role="group" aria-label="Utilities"> <button type="button" class="btn btn-light c-link">Link</button> <button type="button" class="btn btn-light c-image">Image</button></div><div class="btn-group mr-2 mb-1" role="group" aria-label="Lists"> <button type="button" class="btn btn-light c-ul">Bullet</button> <button type="button" class="btn btn-light c-ol">Numbered</button></div></div>'));
